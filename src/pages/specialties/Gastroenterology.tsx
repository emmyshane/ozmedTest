        ...
        <section className="bg-gradient-hero text-primary-foreground py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl lg:text-5xl font-bold mb-6">Gastroenterology Medical Billing Services</h1>
              <p className="text-xl text-primary-foreground/90 mb-8">
                Specialized billing for gastroenterology practices. Expert in endoscopy, colonoscopy, and GI procedure coding.
              </p>
              <Link to="/free-audit">
