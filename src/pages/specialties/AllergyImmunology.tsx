        ...
        <section className="bg-gradient-hero text-primary-foreground py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl lg:text-5xl font-bold mb-6">Allergy and Immunology Billing</h1>
              <p className="text-xl text-primary-foreground/90 mb-8">
                Specialized billing for allergy and immunology practices. Expert in testing, immunotherapy, and treatment coding.
              </p>
              <Link to="/free-audit">
