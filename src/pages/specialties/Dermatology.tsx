...
const Dermatology = () => {
  ...
  const challenges = [
    "Cosmetic vs. medical procedure distinctions",
    "Destruction and excision billing complexities",
    "Phototherapy and laser treatment coding",
    "Biopsy and pathology billing coordination",
    "Multiple lesion treatment documentation",
    "Mohs surgery and reconstruction billing"
  ];

  const services = [
    "Medical dermatology E/M coding",
    "Surgical dermatology procedures",
    "Cosmetic procedure billing",
    "Mohs micrographic surgery billing",
    "Phototherapy and laser billing",
    "Pathology coordination and billing"
  ];

  const commonCodes = [
    { code: "17000", description: "Destruction of premalignant lesion" },
    { code: "11102", description: "Tangential biopsy of skin" },
    { code: "17311", description: "Mohs micrographic surgery, first stage" },
    { code: "96912", description: "Photochemotherapy (PUVA)" },
    { code: "11042", description: "Debridement, subcutaneous tissue" },
    { code: "11400", description: "Excision, benign lesion, trunk/extremities" }
  ];
        ...
        <section className="bg-gradient-hero text-primary-foreground py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl lg:text-5xl font-bold mb-6">Dermatology Billing Services</h1>
              <p className="text-xl text-primary-foreground/90 mb-8">
                Specialized billing for dermatology practices. Expert coding for medical and cosmetic procedures, Mohs surgery, and pathology coordination.
              </p>
              <Link to="/free-audit">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground text-center mb-12">
                Dermatology billing requires expertise in distinguishing medical from cosmetic procedures and proper lesion documentation.
              </p>
        ...
        <section className="py-20 bg-section-bg">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground text-center mb-12">
                Our certified coders specialize in dermatology billing, ensuring maximum reimbursement for all procedures.
              </p>
              <div className="grid md:grid-cols-2 gap-6">
        ...
        <section className="py-20 bg-gradient-hero text-primary-foreground">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-primary-foreground/90 mb-8">
                Let our dermatology billing experts maximize your revenue and streamline your billing process.
              </p>
