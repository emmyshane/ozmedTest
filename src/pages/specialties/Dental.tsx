        ...
        <section className="bg-gradient-hero text-primary-foreground py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl lg:text-5xl font-bold mb-6">Dental Billing Services</h1>
              <p className="text-xl text-primary-foreground/90 mb-8">
                Expert billing for dental practices. Specialized in dental procedures, periodontics, and oral surgery coding.
              </p>
              <Link to="/free-audit">
